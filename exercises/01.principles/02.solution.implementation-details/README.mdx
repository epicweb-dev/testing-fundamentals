...
🦉 Intention plays a crucial rule in [The True Purpose of Testing](https://www.epicweb.dev/the-true-purpose-of-testing). Remember: the implementations may change but the intentions stay the same.
