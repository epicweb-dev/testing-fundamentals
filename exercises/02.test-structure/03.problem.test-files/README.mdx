...
🐨 First, <InlineFile file="greet.test.js">Click here to create the `greet.test.js` file</InlineFile>

🐨 Once the `greet.test.js` file is created, move the existing tests from `greet.js` there.
...
🐨 To start, <InlineFile file="setup.js">Click here to create the `setup.js` file</InlineFile>
