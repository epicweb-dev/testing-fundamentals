...
- We should be using `--import` but it's [bugged](https://github.com/nodejs/node/issues/40110#issuecomment-1808755491) in all versions of Node.js right now (also couldn't make it work on Node.js 18 at all).
