...
<CodeFile file="greet.js" range="5" />
...
<CodeFile file="greet.js" range="7-9" highlight="8" />

:tada: Congratulations! You've just written the most basic automated test.

Now, on its own, just _having_ a test doesn't bring us any value. We need to _run_ it. At this stage, we can do that by running the `greet.js` file using Node.js:
